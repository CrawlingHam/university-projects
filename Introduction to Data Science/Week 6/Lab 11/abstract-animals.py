...
class Owner():
    ...
    def __str__(self):
        return (f"Owner is {self.name} who lives in {self.address}.\nEmail: {self.email} and Phone: {self.phonenumber}")
...
class Staff:
    def __init__(self, name, id, department, salary, position):
...
def main():
    ...
    product_manager = Staff("John Doe", "jM4dw1-03n5dw", "Marketing", 120000, "Product Manager")
